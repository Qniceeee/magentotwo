...
/**
 * Class AddNewSimpleProduct3
 * @package Overdose\Lesson6\Setup\Patch\Data
 */
class AddNewSimpleProduct3 implements DataPatchInterface
{
    /**
    ...
    /**
     * AddNewSimpleProduct3 constructor.
    ...
    public function apply()
    {
       ...
       $this->moduleDataSetup->getConnection()->startSetup();
            ...
            try{
                ...
                $set_product->setName('Test Sample Products #3');
